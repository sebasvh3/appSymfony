...
use inventario\appBundle\Entity\Inventario;
use inventario\appBundle\Form\InventarioType;
...
class InventarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('appBundle:Inventario')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('appBundle:Inventario:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('appBundle:Inventario')->find($id);
        ...
        return $this->render('appBundle:Inventario:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('appBundle:Inventario:edit.html.twig', array(
            'entity'      => $entity,
